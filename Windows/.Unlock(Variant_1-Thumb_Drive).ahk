...
File_Description=Open Protected Drive (VeraCrypt Container)
...
; Description: Run to unlock drive on Windows for VeraCrypt containers (primarily used on removable media such as USB thumb drives)
; Version: 0.1
; Date: 17-Feb-2018
; Language: AutoHotkey
...
If A_IsAdmin
{
	Run, "%A_ScriptDir%\.DO_NOT_DELETE\vc.exe" /w /c n /v "%A_ScriptDir%\.DO_NOT_DELETE\vc-container.vc" /a /q /e, %A_ScriptDir%, min
	ExitApp
}
